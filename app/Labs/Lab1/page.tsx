...
tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Preheat oven to 400°F (190°C).</li>
          <li>Put the frozen pizza in the oven.</li>
      ...
      <div id="wd-tables">
        ...
        <table border={1} width="100%">
          ...
          <tbody>
            ...
            <tr>
              <td>Q5</td>
              <td>State in React Applications</td>
              <td>10/24/25</td>
              <td>31</td>
            </tr>
            <tr>
